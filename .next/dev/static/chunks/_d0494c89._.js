...
const api = {
    ...
    statistics: {
        getOverview: async ()=>{
            ...
            // Claims by area
            const claimsByArea = Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ClaimArea"]).reduce((acc, area)=>{
                acc[area] = claims.filter((c)=>c.area === area).length;
                return acc;
            }, {});
            // Claims by type
            const claimsByType = Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ClaimType"]).reduce((acc, type)=>{
                acc[type] = claims.filter((c)=>c.type === type).length;
                return acc;
            }, {});
            // Claims by priority
            const claimsByPriority = Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ClaimPriority"]).reduce((acc, priority)=>{
            ...
            const avgResolutionTimeByType = Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ClaimType"]).reduce((acc, type)=>{
            ...
            // Claims per agent
            const agents = users.filter((u)=>u.role === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UserRole"].AGENT || u.role === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UserRole"].COORDINATOR);
            const claimsPerAgent = agents.map((agent)=>({
                    agentId: agent.id,
                    agentName: agent.name,
                    count: claims.filter((c)=>c.assignedToId === agent.id).length,
                    resolved: claims.filter((c)=>c.assignedToId === agent.id && c.status === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ClaimStatus"].RESOLVED).length
                }));
            return {
...
function AuthProvider({ children }) {
            ...
            const checkSession = {
                "AuthProvider.useEffect.checkSession": async ()=>{
                    ...
                    if (storedUserId && token) {
                        try {
                            const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].auth.getCurrentUser(storedUserId);
                            if (user) {
                                setUser(user);
                            } else {
                                // Token inválido o usuario no existe
                                localStorage.removeItem("claim_sys_user_id");
                                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setAuthToken"])(null);
                            }
                        } catch (e) {
    ...
    const login = async (email, password)=>{
        ...
        setError(null);
        try {
            const { user: loggedUser, token } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].auth.login(email, password);
            setUser(loggedUser);
    ...
    const logout = ()=>{
        setUser(null);
        localStorage.removeItem("claim_sys_user_id");
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].auth.logout();
        router.push("/login");
    };
...
//# sourceMappingURL=_d0494c89._.js.map